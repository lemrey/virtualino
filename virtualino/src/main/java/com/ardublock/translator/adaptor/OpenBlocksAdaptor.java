...
public class OpenBlocksAdaptor implements BlockAdaptor {
    ...
    public TranslatorBlock nextTranslatorBlock(Translator translator,
            Long blockId, String codePrefix, String codeSuffix)
    {
        ...
        if (Block.NULL.equals(blockId)) {
            ...
            TranslatorBlock translatorBlock =
                    translatorBlockFactory.buildTranslatorBlock(translator,
                    blockId, block.getGenusName(), codePrefix, codeSuffix,
                    block.getBlockLabel());
            return translatorBlock;
        }
    }

    public TranslatorBlock getTranslatorBlockAtSocket(Translator translator,
            Long blockId, int i, String codePrefix, String codeSuffix)
    {
        Block block = translator.getBlock(blockId);
        if (block == null) {
            return null;
        ...
        if (Block.NULL.equals(blockId)) {
            ...
            block = translator.getBlock(blockId);
            //System.out.println("name: " + block.getGenusName());
            TranslatorBlock translatorBlock =
                    translatorBlockFactory.buildTranslatorBlock(translator,
                    blockId, block.getGenusName(), codePrefix, codeSuffix,
                    block.getBlockLabel());
